...
const ChatAi = (): JSX.Element => (
  <Card className="col-start-1 col-end-5 md:col-start-1 md:col-end-3 row-start-1 row-end-7 overflow-hidden relative p-0.5 border-none">
    <span className='absolute inset-[-1000%] animate-[spin_5s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#09090b_0%,#0891b2_25%,#09090b_50%,#0891b2_75%,#09090b_100%)]' />
    <a
      href="//rag.kamilo.dev"
